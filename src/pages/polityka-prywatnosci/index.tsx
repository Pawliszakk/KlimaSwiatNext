		...
		<div className={classes.box}>
			...
			<ol>
				<li>
					...
					url: <b>klimaswiat.pl</b>
				</li>
				<li>
					{' '}
					Operatorem serwisu oraz Administratorem danych osobowych jest: Klima
					Świat Kamil Pachla Piłsudskiego 12 22-435 Komarów-Osada
				</li>
				<li>
					{' '}
					Adres kontaktowy poczty elektronicznej operatora:
					pachlakamil9@gmail.com
				</li>
				<li>
					{' '}
